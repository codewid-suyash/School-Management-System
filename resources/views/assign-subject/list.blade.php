                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><a href="{{ route('assign-subject.create') }}">Create Assign
                                        Subject</a> </h3>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 d-flex align-items-end">
                                            <div class="form-group">
                                                ...
                                                <button onclick="window.location='{{ route('assign-subject.read') }}'" type="reset" class="btn btn-secondary">Reset</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
